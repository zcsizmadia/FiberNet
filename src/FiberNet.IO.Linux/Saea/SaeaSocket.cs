...
/// <summary>
/// Linux SAEA (SocketAsyncEventArgs) socket — zero-alloc completions via pre-allocated
/// event-arg pools pinned at startup.
/// </summary>
internal sealed class SaeaSocket : IFiberNetSocket
{
    private readonly Socket _socket;

    internal SaeaSocket(Socket socket) => _socket = socket;
